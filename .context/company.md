...
Founder operates across two businesses:

## UVRelining (Peanta Inventions AB)

- **Industry:** Trenchless pipe rehabilitation / CIPP (Cured-in-Place Pipe) lining
- **Location:** Verkstadsvägen 24, 245 34 Staffanstorp, Sweden
- **Org. nr:** 559048-4621
- **CSO:** Taus Gerner-Rasmussen (taus@uvrelining.com, +46 70 990 11 22)
- **Website:** uvrelining.com
- **Tagline:** "Bringing light to a dark situation"
...
- **Industry:** Knowledge tools / Documentation
- **Stage:** Building (early stage, side project)
- **Team:** Solo founder
